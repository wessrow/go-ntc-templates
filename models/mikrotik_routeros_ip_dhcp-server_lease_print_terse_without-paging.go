...
type MikrotikRouterosIpDhcpServerLeasePrintTerseWithoutPaging struct {
...
var MikrotikRouterosIpDhcpServerLeasePrintTerseWithoutPaging_Template = `Value INDEX (\d+)
Value FLAG ([XRDB]+)
Value COMMENT (.*)
Value ADDRESS (\S+)
