...
type FortinetGetRouterInfoRoutingTableAll struct {
...
var FortinetGetRouterInfoRoutingTableAll_Template = `Value Filldown TYPE ((?:K|C|S|R|B|O|IA|N1|N2|E1|E2|i|L1|L2|ia|\*|\s)+?)
