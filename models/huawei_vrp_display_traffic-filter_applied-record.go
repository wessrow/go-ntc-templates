...
type HuaweiVrpDisplayTrafficFilterAppliedRecord struct {
...
var HuaweiVrpDisplayTrafficFilterAppliedRecord_Template = `Value Filldown INSTANCE_TYPE (Interface|Traffic profile)
